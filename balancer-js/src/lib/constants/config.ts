...
export const BALANCER_NETWORK_CONFIG: Record<Network, BalancerNetworkConfig> = {
  ...
  [Network.TENET_TESTNET]: {
    chainId: Network.TENET_TESTNET, 
    //Arbitrum deployment addresses: https://docs.balancer.fi/reference/contracts/deployment-addresses/arbitrum.html
    addresses: {
      contracts: {
        multicall: '0x8E9232021911233950833830cc1121A26eC7fade',
        poolDataQueries: '0x3b04355e5f5E05157abD796aBb51Cef1f926fd9e',
        ...addressesByNetwork[Network.TENET_TESTNET].contracts,
      },
      tokens: {
        bal: addressesByNetwork[Network.TENET_TESTNET].contracts.bal,
        wrappedNativeAsset: addressesByNetwork[Network.TENET_TESTNET].contracts.weth,
        lbpRaisingTokens: [
        ],
        ...addressesByNetwork[Network.TENET_TESTNET].tokens,
      },
    },
    urls: {
      subgraph:
        'https://subgraph-testnet.tenet.org/subgraphs/name/balancer-v2'
    },
    thirdParty: {
      coingecko: {
        nativeAssetId: 'tenet',
